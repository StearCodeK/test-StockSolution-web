...
export default function MovimientosTable({ data, isAdmin, isLoading }) {
    return (
        <div className="table-container">
            <table className="admin-table">
                ...
                <tbody>
                    {isLoading ? (
                        <tr>
                            <td colSpan={isAdmin ? 18 : 17} className="loading-data">
                                Cargando datos...
                            </td>
                        </tr>
                    ) : data.length === 0 ? (
                        <tr>
                            <td colSpan={isAdmin ? 18 : 17} className="no-data">
